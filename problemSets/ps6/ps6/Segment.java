...
public class Segment implements Shape {
	 ...
	 */
	public Segment(int x1, int y1, int strokeWeight, Color color) {
	 ...
	 */
	public Segment(int x1, int y1, int x2, int y2, int strokeWeight, Color color) {
	...
	public boolean contains(int x, int y) {
		return pointToSegmentDistance(x, y, x1, y1, x2, y2) <= containsBuffer;
	}
	...
	public String toString() {
		return "segment: " + x1 + " " + y1 + " " + x2 + " " + y2 + " " + strokeWeight + " " + color.getRGB();
	}
}